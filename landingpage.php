...
<ul class="contacts">
  <li><h3><i class='bx bx-mobile-alt'></i> Mobile Number</h3> <?php echo htmlspecialchars($result['mobilenumber']);?></li>
  <li class="email"><h3><i class='bx bx-envelope'></i> Email Address</h3> <a href="mailto:info@example.com"><?php echo htmlspecialchars($result['emailaddress']);?></a></li>
  <li><h3><i class='bx bx-phone' ></i>Telephone Number</h3> <?php echo htmlspecialchars($result['phonenumber']);?></li>
</ul>
</div>
</div>
  </section>
