...
$query = "SELECT * FROM tblculling WHERE id = :pigId";
    ...
    <div class="quantity-input">
      ...
      <input type="hidden" class="quantity" name="quantity" id="quantityInput" value="1" min="1" max="50" placeholder="Quantity" required>
                   ...
                   <!-- <button type="submit" class="add-to-cart-btn">Add to Cart</button> -->
                    <button type="button"style="width: 200px;"class="order-btn" data-toggle="modal" data-target="#confirmModal" id="openModalBtn">Order</button>
    </form>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span>&#8369;</span><?=$pig['amount']?></td>
                                                <input type="hidden" name="pig_price" value="<?=$pig['amount']?>">
                                                <td>
                                                <p style="color:black;">1</p>
                                              </td>
                                              <input type="hidden" name="quantity" id="modalQuantityInput" value="1">
                                                <td><?=$pig['age']?></td>
                                                <input type="hidden" name="weight" value="<?=$pig['age']?>">
