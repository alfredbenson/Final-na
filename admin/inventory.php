                ...
                <table id="myTable">
						<thead>
							<tr>  
                                ...
                                style="padding-left: 20px;">Action</th>
    ...
    class="openModalBtn" ><i class='bx bx-plus-circle'></i> Add New</button>
                ...
                <table id="myTable">
						<thead>
							<tr>  
                                <th class="text-center">ID</th>
                                <th class="text-center" style="padding-left: 30px;">Image</th>
								                <th class="text-center">Piglet Name</th>
                                <th class="text-center" style="padding-left: 20px;">Sex</th>
							                	<th class="text-center" style="padding-left: 20px;">Age</th>
                                <th class="text-center" style="padding-left: 50px;">Weight</th>
                                <th class="text-center">Price</th>
                                <th class="text-center">Creation Date</th>  
                                <th class="text-center" style="padding-left: 70px;">Action</th>
...
// age
	...
	<td class="text-center" style="padding-left: 18px;"><?php echo htmlentities($resultpigletslist->groupname); ?></td>
	<td class="text-center" style="padding-left: 20px;"><?php echo htmlentities($resultpigletslist->gender); ?></td>  
    <td class="text-center" style="padding-left: 20px;"><?php echo htmlentities($age); ?></td>
    <td class="text-center" style="padding-left:40px;"><?php echo htmlentities($resultpigletslist->piglet_weight);?> kg</td>
    <td class="text-center" style="padding-left: 18px;"><span>&#8369;</span><?php echo htmlentities($resultpigletslist->price); ?></td>
    <td class="text-center"><?php echo htmlentities($farrrowedddate); ?></td>
    <!-- Button trigger modal -->
    <td class="action text-center">
      <button type="button"  style="padding-left: 70px;" class="btn delete" title="Delete Pig"data-bs-toggle="modal"data-bs-target="#deletepigletModal-<?php echo htmlentities($resultpigletslist->id); ?>">
    <i class='bx bx-trash'></i>
      </button>
      <button type="button" class="btn btn-sm updateModalBtnPiglets" title="Update Piglets"data-bs-toggle="modal"data-bs-target="#updateModalpiglets"data-forpigletsid="<?php echo $resultpigletslist->id; ?>">
