...
?>
	...
	<td class="text-center"><button type="button"  title="Click to view" data-bs-toggle="modal" data-bs-target="#confirmModal" data-orderid="<?php echo htmlentities($cull->order_id); ?>"  
    class="openModalBtn" ><i class='bx bx-message-alt-add'></i></button>
